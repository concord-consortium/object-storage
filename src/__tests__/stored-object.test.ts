...
describe("StoredObject", () => {
  describe("constructor", () => {
    it("should create a StoredObject with a generated id when no id is provided", () => {
      const obj = new StoredObject();
    ...
    it("should create a StoredObject with the provided id", () => {
      const customId = "custom-id-123";
      const obj = new StoredObject({ id: customId });
    ...
    it("should include name in metadata when provided", () => {
      const obj = new StoredObject({ name: "Test Object" });

      expect(obj.metadata.name).toBe("Test Object");
    });

    it("should include description in metadata when provided", () => {
      const obj = new StoredObject({ description: "Test description" });
